...
export const ModalBody = ({
  ...
  const modalRef = useRef<HTMLDivElement>(null);  // RefObject<HTMLDivElement>

  const { setOpen } = useModal();
  useOutsideClick(modalRef as React.RefObject<HTMLDivElement>, () => setOpen(false));  // Type assertion
